...
| `AM12-File-IO-and-Dictionaries-Starter` |
| `AM12-Juni-Latin-with-File-IO` |
| `AM12-Juni-Latin-with-File-IO-Starter` |
...
| `AM2-Functions-Practice-Starter` |
| `AM2-Lists-Practice` |
| `AM2-Lists-Practice-Starter` |
| `AM3-Python-Fundamentals-Problem-Set` |
| `AM3-Python-Fundamentals-Problem-Set-Starter` |
...
| `AM9-Baseball-Analytics-Starter` |
| `AM9-Bubble-Sort` |

## Source Inventory

- Top-level folders: 65
- Active linked folders: 55
- Ledgered inactive/support folders: 10
- Source-like files: 117
