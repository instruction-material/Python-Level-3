...
fun_facts = ["The first oranges weren’t orange.", "There’s only one letter that doesn’t \nappear in any U.S. state name: Q.",
            "A cow-bison hybrid is called a 'beefalo'.", "Scotland has 421 words for 'snow'.", "Peanuts aren’t technically nuts."]
...
while keep_going:
    ...
    if choice[0] == "1":
        ...
        print(str(current_dt.month) + "/" + str(current_dt.day) + "/" + str(current_dt.year))
    elif choice[0] == "3":
